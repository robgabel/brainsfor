...
1. Install the brain pack into `${BRAINSFOR_HOME:-~/.brainsfor}/brains/sun-tzu/`
...
pack/
  ...
  ├── brain-atoms.json      ← Structured data (207 atoms, 377 connections)
...
**377 connections** — Typed relationships between atoms: supports, contradicts, extends, related, inspired_by. These let skills trace reasoning chains and surface productive tensions.
...
**For Claude Code / Cowork:** The skills in `pack/skills/` load automatically once the pack is installed to `${BRAINSFOR_HOME:-~/.brainsfor}/brains/sun-tzu/`. Run `/brain sun-tzu` to activate.
