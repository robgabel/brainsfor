...
pack/
  ...
  brain-atoms.json         ~1MB     Structured data (911 atoms, 961 typed connections)
...
|------|-------------|-----------------|
| `brain-context.md` | Your AI agent | Jeremy's synthesized worldview, all 911 atoms with original quotes and implications, persona rules, skill instructions |
