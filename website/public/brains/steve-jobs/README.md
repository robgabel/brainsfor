...
> **170 knowledge atoms** · **792 typed connections** · **9 unified skills (1 router + 8 reasoning modes)**
> From [brainsforfree.com](https://brainsforfree.com)

## What This Is

A structured knowledge graph of Steve Jobs's thinking, extracted from 50+ years of speeches, interviews, keynotes, and documented conversations (1976–2011). Designed to be loaded as context into any LLM — Claude, ChatGPT, Cursor, or any AI tool that accepts system prompts.

This isn't a chatbot or a persona. It's a **thinking partner** grounded in Steve's actual ideas, frameworks, and worldview.

## Quick Start

1. Install the brain pack into `${BRAINSFOR_HOME:-~/.brainsfor}/brains/steve-jobs/`
...
You should get a response that cites specific atoms, synthesizes Steve's perspective, and recommends what to do next.
...
pack/
  ...
  ├── brain-atoms.json      ← Structured data (170 atoms, 792 connections)
...
- **Install this brain pack first** → `/brain steve-jobs` activates it, then `/advise` / `/teach` / `/surprise` all work.
...
- **Cross-brain mode** — `/debate steve-jobs paul-graham originality` contrasts two thinkers.

## The Knowledge Graph

**170 atoms** — Each atom is a self-contained insight with topic tags, source date, confidence score, and source URL.

**792 connections** — Typed relationships between atoms: supports, contradicts, extends, related, inspired_by. These let skills trace reasoning chains and surface productive tensions.
...
**Date range:** 1976 — 2011

## How to Use

**For Claude Code / Cowork:** The skills in `pack/skills/` load automatically once the pack is installed to `${BRAINSFOR_HOME:-~/.brainsfor}/brains/steve-jobs/`. Run `/brain steve-jobs` to activate.
