---
name: teach
description: "Explain concepts using Steve Jobs's frameworks, language, and mental models."
---

# /teach — Learn Through Jobs's Lens

Explain a concept using Steve Jobs's actual language, frameworks, and mental models — not generic business wisdom.

## How It Works

1. Parse the concept the user wants to understand
2. Find atoms that define, explain, or contextualize this concept
3. Build an explanation using Steve's own vocabulary and framing
4. Show what makes Jobs's angle unique vs. conventional wisdom
...
3. **Show his angle** — What makes Jobs's take different from how everyone else talks about this.
