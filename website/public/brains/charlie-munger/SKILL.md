---
name: brain-setup
description: "Load the Charlie Munger brain. Pack ships 10 unified skills in pack/skills/ — 1 router (/brain) + 8 reasoning modes (/advise, /teach, /debate, /connect, /evolve, /surprise, /coach, /predict) + /board (multi-brain advisory) — that work with this brain and any other installed BrainsFor brain."
---

# Charlie Munger Brain Pack — Setup & Configuration

Welcome to the **Munger Brain Pack** from [brainsforfree.com](https://brainsforfree.com). This is a premium knowledge asset extracted from Charlie Munger's Poor Charlie's Almanack, Berkshire Hathaway and Wesco annual meetings, Daily Journal meetings, and commencement speeches — a curated collection of his most influential thinking on mental models, investing, psychology of human misjudgment, and the art of worldly wisdom.
...
Your Munger Brain Pack folder should contain:
...
Test your setup with the Quick Start prompt below. You should get a thoughtful response grounded in Charlie's thinking.
...
*Requires 2+ brains installed, plus a host that can run parallel sub-agents (Claude Code's Agent tool or Cowork). No MCP server needed — each board member reads its brain's local pack. With only Charlie Munger installed, `/board` will ask you to add another brain from [brainsforfree.com](https://brainsforfree.com).*
...
- Weighs tradeoffs from Charlie's perspective
...
→ Use `/advise` with a keyword: `"What does Charlie think about mental models?"` → The brain will pull all relevant atoms.
...
**You're ready to think with Charlie. Let's go.** 🚀
