---
name: teach
description: "Explain concepts using John Green's frameworks, language, and mental models."
---

# /teach — Learn Through Green's Lens

Explain a concept using John Green's actual language, frameworks, and mental models — not generic business wisdom.

## How It Works

1. Parse the concept the user wants to understand
2. Find atoms that define, explain, or contextualize this concept
3. Build an explanation using John's own vocabulary and framing
