...
Welcome to the **Brown Brain Pack** from [brainsforfree.com](https://brainsforfree.com). This is a premium knowledge asset extracted from Brené Brown's Research on vulnerability, courage, shame, and empathy — a curated collection of her groundbreaking research on vulnerability, courage, shame resilience, and wholehearted living.
...
*Requires 2+ brains installed, plus a host that can run parallel sub-agents (Claude Code's Agent tool or Cowork). No MCP server needed — each board member reads its brain's local pack. With only Brené Brown installed, `/board` will ask you to add another brain from [brainsforfree.com](https://brainsforfree.com).*
