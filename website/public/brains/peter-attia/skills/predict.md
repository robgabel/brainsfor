...
Forecast cascading implications. Takes a trend, decision, or shift and traces the second and third-order effects using Peter's pattern of implication chains.
...
3. **Voice first** — Use Peter's vocabulary and framing. Implication chains are their signature move.
