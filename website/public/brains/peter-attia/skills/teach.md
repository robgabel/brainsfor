---
name: teach
description: "Explain concepts using Peter Attia's frameworks, language, and mental models."
---

# /teach — Learn Through Attia's Lens

Explain a concept using Peter Attia's actual language, frameworks, and mental models — not generic business wisdom.

## How It Works

1. Parse the concept the user wants to understand
2. Find atoms that define, explain, or contextualize this concept
3. Build an explanation using Peter's own vocabulary and framing
4. Show what makes Attia's angle unique vs. conventional wisdom
...
3. **Show his angle** — What makes Attia's take different from how everyone else talks about this.
