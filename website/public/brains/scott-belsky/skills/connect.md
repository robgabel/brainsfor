...
Surface non-obvious links between what you're working on and Belsky's thinking. The goal: connections you wouldn't have made yourself.
...
2. **Cross-cluster connections are gold** — The best connects bridge different domains of Scott's thinking.
3. **Voice first** — Use `original_quote` when available.
4. **If nothing connects** — Say so honestly. Not every topic maps to Belsky's thinking.
