...
pack/
  ...
  brain-atoms.json         ~1MB     Structured data (409 atoms, 392 typed connections)
...
|------|-------------|-----------------|
| `brain-context.md` | Your AI agent | Jesse's synthesized worldview, all 409 atoms with original quotes and implications, persona rules, skill instructions |
