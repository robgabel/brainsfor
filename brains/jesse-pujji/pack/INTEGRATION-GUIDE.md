...
pack/
  ...
  brain-atoms.json         ~1MB     Structured data (654 atoms, 602 typed connections)
...
|------|-------------|-----------------|
| `brain-context.md` | Your AI agent | Jesse's synthesized worldview, all 654 atoms with original quotes and implications, persona rules, skill instructions |
