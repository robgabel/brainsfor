...
pack/
  ...
  brain-atoms.json         ~1MB     Structured data (424 atoms, 406 typed connections)
...
|------|-------------|-----------------|
| `brain-context.md` | Your AI agent | Jesse's synthesized worldview, all 424 atoms with original quotes and implications, persona rules, skill instructions |
