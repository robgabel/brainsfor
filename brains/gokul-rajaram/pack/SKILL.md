---
name: brain-setup
description: "Load the Gokul Rajaram brain. Pack ships 10 unified skills in pack/skills/ — 1 router (/brain) + 8 reasoning modes (/advise, /teach, /debate, /connect, /evolve, /surprise, /coach, /predict) + /board (multi-brain advisory) — that work with this brain and any other installed BrainsFor brain."
---

# Gokul Rajaram Brain Pack — Setup & Configuration

Welcome to the **Rajaram Brain Pack** from [brainsforagents.com](https://brainsforagents.com). This is a premium knowledge asset extracted from Gokul Rajaram's long-form interviews, conference talks, and essays on product leadership, decision-making (SPADE), ads monetization, founder mode, AI-era software defensibility, angel investing, and company building — a curated collection of his sharpest thinking on product leadership, ads monetization, decision-making, AI-era defensibility, founder mode, and angel investing across 700+ companies.
...
*Example: "Walk me through SPADE on a real decision: I have to choose between three pricing models and the team can't agree."*
...
*Requires 2+ brains installed, plus a host that can run parallel sub-agents (Claude Code's Agent tool or Cowork). No MCP server needed — each board member reads its brain's local pack. With only Gokul Rajaram installed, `/board` will ask you to add another brain from [brainsforagents.com](https://brainsforagents.com).*
...
/advise "I'm a founder trying to make a high-stakes call and three different people want different things. How would Gokul cut through the consensus trap?"
```

Or skip the activation step and use an inline slug for a one-off:

```
/advise gokul-rajaram "I'm a founder trying to make a high-stakes call and three different people want different things. How would Gokul cut through the consensus trap?"
```
...
→ Use `/advise` with a keyword: `"What does Gokul think about decision-making with SPADE?"` → The brain will pull all relevant atoms.
