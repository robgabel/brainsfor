...
pack/
  ...
  brain-atoms.json         ~1MB     Structured data (865 atoms, 795 typed connections)
...
|------|-------------|-----------------|
| `brain-context.md` | Your AI agent | Gokul's synthesized worldview, all 865 atoms with original quotes and implications, persona rules, skill instructions |
...
This is why installing multiple brains gives you genuinely different perspectives — and why the cross-brain skills work. Gokul Rajaram brings a specific worldview to your decisions; pair with other brains for productive tension.
