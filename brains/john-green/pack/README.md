...
> **708 knowledge atoms** · **698 typed connections** · **10 unified skills (1 router + 8 reasoning modes + a board of advisors)**
...
- **Cross-brain mode** — `/debate john-green paul-graham originality` contrasts two thinkers; `/board <question>` convenes every installed brain at once (needs 2+).
