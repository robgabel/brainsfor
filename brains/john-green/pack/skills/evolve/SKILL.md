---
name: evolve
description: "Trace how John Green's thinking on a topic has evolved over time."
---

# /evolve — Intellectual Evolution

Trace how John's thinking on a topic developed over time. Shows the arc: early position → refinements → current stance. The evolution IS the insight.
