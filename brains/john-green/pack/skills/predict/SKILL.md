---
name: predict
description: "Implication chains from John Green's thinking. What happens next if X — cascading second and third-order effects."
---

# /predict — What Happens Next

Forecast cascading implications. Takes a trend, decision, or shift and traces the second and third-order effects using John's pattern of implication chains.
...
3. **Voice first** — Use John's vocabulary and framing. Implication chains are their signature move.
