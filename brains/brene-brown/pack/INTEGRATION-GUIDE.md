...
pack/
  ...
  brain-atoms.json         ~1MB     Structured data (283 atoms, 1000 typed connections)
...
|------|-------------|-----------------|
| `brain-context.md` | Your AI agent | Brené's synthesized worldview, all 283 atoms with original quotes and implications, persona rules, skill instructions |
...
4. Use any thinking skill:
   ...
   /debate Is vulnerability a strength or weakness in leadership?
   /predict What happens to organizations that embrace vulnerability?
   /surprise
   ```
