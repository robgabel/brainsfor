...
pack/
  ...
  brain-atoms.json         ~1MB     Structured data (684 atoms, 637 typed connections)
...
|------|-------------|-----------------|
| `brain-context.md` | Your AI agent | Oprah's synthesized worldview, all 684 atoms with original quotes and implications, persona rules, skill instructions |
