...
pack/
  ...
  brain-atoms.json         ~1MB     Structured data (651 atoms, 641 typed connections)
...
|------|-------------|-----------------|
| `brain-context.md` | Your AI agent | Hank's synthesized worldview, all 651 atoms with original quotes and implications, persona rules, skill instructions |
...
This is why installing multiple brains gives you genuinely different perspectives — and why the cross-brain skills work. Hank Green brings a specific worldview to your decisions; pair with other brains for productive tension.
