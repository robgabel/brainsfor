---
name: brain-setup
description: "Load the Hank Green brain. Pack ships 10 unified skills in pack/skills/ — 1 router (/brain) + 8 reasoning modes (/advise, /teach, /debate, /connect, /evolve, /surprise, /coach, /predict) + /board (multi-brain advisory) — that work with this brain and any other installed BrainsFor brain."
---

# Hank Green Brain Pack — Setup & Configuration

Welcome to the **Green Brain Pack** from [brainsforfree.com](https://brainsforfree.com). This is a premium knowledge asset extracted from Hank Green's SciShow, Crash Course, Vlogbrothers, TikTok videos, Dear Hank & John podcast, interviews, TED talks, and two novels — a curated collection of his sharpest thinking on science communication, creator economy, attention, community, and why curiosity beats cynicism.
...
*Requires 2+ brains installed, plus a host that can run parallel sub-agents (Claude Code's Agent tool or Cowork). No MCP server needed — each board member reads its brain's local pack. With only Hank Green installed, `/board` will ask you to add another brain from [brainsforfree.com](https://brainsforfree.com).*
...
This brain was built exclusively from **freely available, public sources** — Green's freely distributed YouTube videos (SciShow, Crash Course, Vlogbrothers), TikTok content, Dear Hank & John podcast, TED talks, and press interviews. His novel ideas are represented through publicly available author interviews and discussions, not from book text.. No transcripts from commercial works (e.g., audiobooks, paid courses) or paywalled essays were used to derive this brain.
