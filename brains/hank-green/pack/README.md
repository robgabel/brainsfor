...
> **651 knowledge atoms** · **641 typed connections** · **10 unified skills (1 router + 8 reasoning modes + a board of advisors)**
...
- **Cross-brain mode** — `/debate hank-green paul-graham originality` contrasts two thinkers; `/board <question>` convenes every installed brain at once (needs 2+).
