...
pack/
  ...
  brain-atoms.json         ~1MB     Structured data (874 atoms, 719 typed connections)
...
|------|-------------|-----------------|
| `brain-context.md` | Your AI agent | Elon's synthesized worldview, all 874 atoms with original quotes and implications, persona rules, skill instructions |
