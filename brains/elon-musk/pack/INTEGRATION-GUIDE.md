...
pack/
  ...
  brain-atoms.json         ~1MB     Structured data (845 atoms, 719 typed connections)
...
|------|-------------|-----------------|
| `brain-context.md` | Your AI agent | Elon's synthesized worldview, all 845 atoms with original quotes and implications, persona rules, skill instructions |
