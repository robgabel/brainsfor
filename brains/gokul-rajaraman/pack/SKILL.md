---
name: brain-setup
description: "Load the Gokul Rajaraman brain. Pack ships 9 unified skills in pack/skills/ — 1 router (/brain) + 8 reasoning modes (/advise, /teach, /debate, /connect, /evolve, /surprise, /coach, /predict) — that work with this brain and any other installed BrainsFor brain."
---

# Gokul Rajaraman Brain Pack — Setup & Configuration

Welcome to the **Rajaraman Brain Pack** from [brainsforfree.com](https://brainsforfree.com). This is a premium knowledge asset extracted from Gokul Rajaraman's public talks, interviews, and writing on product, social media, and the creator economy — a curated collection of his sharpest thinking on product leadership, ads/monetization, decision-making, angel investing, and how AI is reshaping how products get built.
...
These skills live in `pack/skills/` and are brain-agnostic — they work with Gokul Rajaraman and with any other BrainsFor brain installed under `${BRAINSFOR_HOME:-~/.brainsfor}/brains/`. Set the active brain with `/brain gokul-rajaraman`, or override per call with an inline slug like `/advise gokul-rajaraman <question>`.

### 🎛️ **0. /brain** — Router
Set, show, list, or clear the active brain for the session.
*Usage: `/brain gokul-rajaraman` activates, `/brain` shows current, `/brain list` shows all installed, `/brain clear` unsets.*
...
```
/advise gokul-rajaraman "I'm building a social product and trying to decide whether to focus on creators or consumers first. What would Gokul think?"
```
