...
> **460 knowledge atoms** · **308 typed connections** · **9 unified skills (1 router + 8 reasoning modes)**
...
pack/
  ...
  ├── brain-atoms.json      ← Structured data (460 atoms, 308 connections)
...
**460 atoms** — Each atom is a self-contained insight with topic tags, source date, confidence score, and source URL.

**308 connections** — Typed relationships between atoms: supports, contradicts, extends, related, inspired_by. These let skills trace reasoning chains and surface productive tensions.
