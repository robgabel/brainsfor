...
pack/
  ...
  brain-atoms.json         ~1MB     Structured data (669 atoms, 632 typed connections)
...
|------|-------------|-----------------|
| `brain-context.md` | Your AI agent | Peter's synthesized worldview, all 669 atoms with original quotes and implications, persona rules, skill instructions |
