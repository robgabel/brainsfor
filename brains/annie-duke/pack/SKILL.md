...
Welcome to the **Duke Brain Pack** from [brainsforfree.com](https://brainsforfree.com). This is a premium knowledge asset extracted from Annie Duke's books, talks, and interviews — a curated collection of her most rigorous thinking on decision-making under uncertainty, quitting strategically, cognitive bias, and probabilistic reasoning.
...
*Requires 2+ brains installed, plus a host that can run parallel sub-agents (Claude Code's Agent tool or Cowork). No MCP server needed — each board member reads its brain's local pack. With only Annie Duke installed, `/board` will ask you to add another brain from [brainsforfree.com](https://brainsforfree.com).*
