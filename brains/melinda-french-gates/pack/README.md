# Melinda French Gates Brain Pack

> **439 knowledge atoms** · **394 typed connections** · **9 unified skills (1 router + 8 reasoning modes)**
> From [brainsforfree.com](https://brainsforfree.com)

## What This Is

A structured knowledge graph of Melinda French Gates's thinking, extracted from Wikipedia profile, CNN and Reuters coverage of her foundation departure, The Guardian book review of The Next Day, NYT interview on abortion and politics, Biography.com profile, Forbes Power Women profiles, BBC News features, and multiple major press deep-dives spanning her career at Microsoft, the Gates Foundation, and her independent philanthropic chapter. Designed to be loaded as context into any LLM — Claude, ChatGPT, Cursor, or any AI tool that accepts system prompts.

This isn't a chatbot or a persona. It's a **thinking partner** grounded in Melinda's actual ideas, frameworks, and worldview.

## Quick Start

1. Install the brain pack into `${BRAINSFOR_HOME:-~/.brainsfor}/brains/melinda-french-gates/`
...
3. Then run any thinking skill:
   ```
   /advise "I'm designing a philanthropic program for adolescent girls in low-income countries. Where should I focus first?"
   ```

You should get a response that cites specific atoms, synthesizes Melinda's perspective, and recommends what to do next.
...
pack/
  ...
  ├── brain-atoms.json      ← Structured data (439 atoms, 394 connections)
...
- **Install this brain pack first** → `/brain melinda-french-gates` activates it, then `/advise` / `/teach` / `/surprise` all work.
...
- **Cross-brain mode** — `/debate melinda-french-gates paul-graham originality` contrasts two thinkers.

## The Knowledge Graph

**439 atoms** — Each atom is a self-contained insight with topic tags, source date, confidence score, and source URL.

**394 connections** — Typed relationships between atoms: supports, contradicts, extends, related, inspired_by. These let skills trace reasoning chains and surface productive tensions.

**16 topic clusters** — Gender equity, global health, women's economic empowerment, philanthropy, family planning, leadership, reinvention, power and money.

**Date range:** 2006 — April 2025

## How to Use

**For Claude Code / Cowork:** The skills in `pack/skills/` load automatically once the pack is installed to `${BRAINSFOR_HOME:-~/.brainsfor}/brains/melinda-french-gates/`. Run `/brain melinda-french-gates` to activate.
