...
pack/
  ...
  brain-atoms.json         ~1MB     Structured data (496 atoms, 477 typed connections)
...
|------|-------------|-----------------|
| `brain-context.md` | Your AI agent | Melinda's synthesized worldview, all 496 atoms with original quotes and implications, persona rules, skill instructions |
...
**Verify it works:** Ask your agent a strategy question and check that the response cites specific ideas from Melinda, not generic advice. Try `I want to do more good in the world but I don't know where to start. What would Melinda think?`.
...
4. Use any thinking skill:
   ```
   /advise I run a nonprofit focused on maternal health. How should I think about measuring real impact versus vanity metrics?
   /debate Is top-down philanthropy from billionaires more harmful than helpful?
   /predict What happens to global health outcomes if reproductive rights continue to be rolled back in wealthy countries?
   /surprise
   ```
