---
name: connect
description: "Semantic search for unexpected connections between your topic and Peter Attia's ideas."
---

# /connect — The Serendipity Engine

Surface non-obvious links between what you're working on and Attia's thinking. The goal: connections you wouldn't have made yourself.
...
```
🔗 **Unexpected Connection: [Your Topic] ↔ [Attia's Framework]**
...
2. **Cross-cluster connections are gold** — The best connects bridge different domains of Peter's thinking.
3. **Voice first** — Use `original_quote` when available.
4. **If nothing connects** — Say so honestly. Not every topic maps to Attia's thinking.
