...
Present a position. Attia argues against it using his actual thinking — real counterarguments from atoms, not generic objections.

## How It Works

1. Parse your position and identify the core claim
2. Search for atoms that challenge, complicate, or contradict it
3. Build a steel-manned counterargument using Peter's frameworks
...
2. **Voice first** — Use `original_quote` language. Peter's provocations are the product.
