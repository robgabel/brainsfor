...
> **687 knowledge atoms** · **668 typed connections** · **9 unified skills (1 router + 8 reasoning modes)**
...
- **Cross-brain mode** — `/debate reshma-saujani paul-graham originality` contrasts two thinkers.
