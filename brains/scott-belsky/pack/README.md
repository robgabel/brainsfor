...
> **1086 knowledge atoms** · **1174 typed connections** · **10 unified skills (1 router + 8 reasoning modes + a board of advisors)**
...
- **Cross-brain mode** — `/debate scott-belsky paul-graham originality` contrasts two thinkers; `/board <question>` convenes every installed brain at once (needs 2+).
