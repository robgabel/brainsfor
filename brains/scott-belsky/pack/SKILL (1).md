---
name: brain-setup
description: "Load the Scott Belsky brain. Pack ships 9 unified skills in pack/skills/ — 1 router (/brain) + 8 reasoning modes (/advise, /teach, /debate, /connect, /evolve, /surprise, /coach, /predict) — that work with this brain and any other installed BrainsFor brain."
---
...
These skills live in `pack/skills/` and are brain-agnostic — they work with Scott Belsky and with any other BrainsFor brain installed under `${BRAINSFOR_HOME:-~/.brainsfor}/brains/`. Set the active brain with `/brain scott-belsky-v2`, or override per call with an inline slug like `/advise scott-belsky-v2 <question>`.

### 🎛️ **0. /brain** — Router
Set, show, list, or clear the active brain for the session.
*Usage: `/brain scott-belsky-v2` activates, `/brain` shows current, `/brain list` shows all installed, `/brain clear` unsets.*
...
```
/advise scott-belsky-v2 "I'm building a creative tool and trying to decide whether to optimize for power users or beginners. What would Scott think?"
```
