...
🎯 **The question behind the questions:** [The real issue Scott would zero in on]
...
3. **Voice first** — Frame questions the way Scott actually thinks. Use their vocabulary, their metaphors, their mental models.
...
5. **Name the meta-question** — End with "the question behind the questions" — the real thing Scott would push them to confront.
