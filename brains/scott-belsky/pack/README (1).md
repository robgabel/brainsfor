...
1. Install the brain pack into `${BRAINSFOR_HOME:-~/.brainsfor}/brains/scott-belsky-v2/`
...
- **Install this brain pack first** → `/brain scott-belsky-v2` activates it, then `/advise` / `/teach` / `/surprise` all work.
...
- **Cross-brain mode** — `/debate scott-belsky-v2 paul-graham originality` contrasts two thinkers.
...
**For Claude Code / Cowork:** The skills in `pack/skills/` load automatically once the pack is installed to `${BRAINSFOR_HOME:-~/.brainsfor}/brains/scott-belsky-v2/`. Run `/brain scott-belsky-v2` to activate.
