# Paul Graham — Role-Play Baseline Eval

- **Run:** 2026-04-22T04:58:59.101295+00:00
- **Mode:** Role-play (no brain context)
- **Target skills:** advise, debate, surprise
...
- **Total cost:** $0.000 (runner only) + judge calls
- **Runtime:** 189.2s

## Dimensions (1-5 mean)

- **Voice Fidelity** (weight 30%): 4.73 / 5
