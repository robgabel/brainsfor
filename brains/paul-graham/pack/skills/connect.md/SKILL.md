---
name: connect
description: "Semantic search for unexpected connections between your topic and Paul Graham's ideas."
---

# /connect — The Serendipity Engine

Surface non-obvious links between what you're working on and Graham's thinking. The goal: connections you wouldn't have made yourself.
...
```
🔗 **Unexpected Connection: [Your Topic] ↔ [Graham's Framework]**
...
2. **Cross-cluster connections are gold** — The best connects bridge different domains of Paul's thinking.
3. **Voice first** — Use `original_quote` when available.
4. **If nothing connects** — Say so honestly. Not every topic maps to Graham's thinking.
