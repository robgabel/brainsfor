...
# /teach — Learn Through Graham's Lens

Explain a concept using Paul Graham's actual language, frameworks, and mental models — not generic business wisdom.

## How It Works

1. Parse the concept the user wants to understand
2. Find atoms that define, explain, or contextualize this concept
3. Build an explanation using Paul's own vocabulary and framing
4. Show what makes Graham's angle unique vs. conventional wisdom
