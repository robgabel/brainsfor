---
name: predict
description: "Implication chains from Paul Graham's thinking. What happens next if X — cascading second and third-order effects."
---

# /predict — What Happens Next

Forecast cascading implications. Takes a trend, decision, or shift and traces the second and third-order effects using Paul's pattern of implication chains.
...
3. **Voice first** — Use Paul's vocabulary and framing. Implication chains are their signature move.
