...
pack/
  ...
  brain-atoms.json         ~1MB     Structured data (213 atoms, 975 typed connections)
...
|------|-------------|-----------------|
| `brain-context.md` | Your AI agent | Paul's synthesized worldview, all 213 atoms with original quotes and implications, persona rules, skill instructions |
