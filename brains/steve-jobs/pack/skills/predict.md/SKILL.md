---
name: predict
description: "Implication chains from Steve Jobs's thinking. What happens next if X — cascading second and third-order effects."
---

# /predict — What Happens Next

Forecast cascading implications. Takes a trend, decision, or shift and traces the second and third-order effects using Steve's pattern of implication chains.
...
⚡ **The contrarian bet:** [What you should do NOW if this chain plays out]

📊 **Confidence:** High / Medium / Low — [1 sentence on how well-grounded this chain is in the brain's data]
...
2. **Grounded, not speculative** — Every step must connect to at least one atom. If the brain doesn't have enough data, say so and shorten the chain.
3. **Voice first** — Use Steve's vocabulary and framing. Implication chains are their signature move.
...
- **atoms:** brain-atoms.json (170 atoms, 792 connections)
