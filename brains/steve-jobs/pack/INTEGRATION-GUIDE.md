...
pack/
  ...
  brain-atoms.json         ~1MB     Structured data (1076 atoms, 1016 typed connections)
...
|------|-------------|-----------------|
| `brain-context.md` | Your AI agent | Steve's synthesized worldview, all 1076 atoms with original quotes and implications, persona rules, skill instructions |
