...
export function registerListBrains(server, brainsDir) {
    server.registerTool("list_brains", {
        title: "List Installed Brains",
        description: "List all installed BrainsFor brain packs with metadata. Returns slug, name, source, atom count, and connection count for each brain.",
