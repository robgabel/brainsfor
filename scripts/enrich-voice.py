...
def process_atoms(atoms: list, extraction_prompt: str, dry_run: bool = False, title_to_url: dict = None) -> list:
...
def main():
    ...
    results = process_atoms(atoms, extraction_prompt, dry_run=args.dry_run, title_to_url=title_to_url)
